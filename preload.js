...
contextBridge.exposeInMainWorld("hachiGen", {
	...
	addCredentialProfile: values => invoke("manager:add-credential-profile", values),
	removeCredentialProfile: profileId => invoke("manager:remove-credential-profile", profileId),
	assignCredentialProfile: (deploymentId, profileId) => invoke("manager:assign-credential-profile", deploymentId, profileId),
